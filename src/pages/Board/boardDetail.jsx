    ...
    <div id={styles.wrapper}>
      ...
      <div id={styles.wrapper2}>
        <div id={styles.boardDetail}>
          ...
          <div id={styles.etc}>
            {new Date(board.time).getFullYear() +
              new Date(board.time).getMonth() +
              new Date(board.time).getDay() +
              new Date(board.time).getHours() +
              new Date(board.time).getMinutes() +
              new Date(board.time).getSeconds() ===
            new Date(board.updateTime).getFullYear() +
              new Date(board.updateTime).getMonth() +
              new Date(board.updateTime).getDay() +
              new Date(board.updateTime).getHours() +
              new Date(board.updateTime).getMinutes() +
            ...
            {board.user_id === sessionStorage.getItem("id") ? (
              <div id={styles.edit}>
          ...
          {board.postImgUrl == null ? null : (
            <div id={styles.boardImage}>
              <img src={board.postImgUrl}></img>
            </div>
          )}
