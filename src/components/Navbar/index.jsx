  ...
  return (
    <div className={styles.navbar}>
      <div className={styles.left_plus}>
        <Link to={"/grade"}>
          <button className={styles.btn_grade}>
            <svg
            ...
            >
              <path
                ...
                fill={active === "/grade" ? "#DE496E" : "black"}
              />
            </svg>
            {active === "/grade" ? (
        ...
        <Link to={"/rank"}>
          <button className={styles.btn_rank}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              <path
                ...
                stroke={active === "/rank" ? "#DE496E" : "black"}
                strokeWidth="1.5"
                strokeLinecap="round"
      ...
      <div className={styles.right_plus}>
        <Link to={"/board"}>
          <button className={styles.btn_board}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              <path
                ...
                stroke={active === "/board" ? "#DE496E" : "black"}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
          ...
          <button className={styles.btn_profile}>
            ...
            >
              <path
                ...
                fill={active === "/profile" ? "#DE496E" : "black"}
              />
            </svg>
            {active === "/profile" ? (
              <span className={styles.activebg}></span>
